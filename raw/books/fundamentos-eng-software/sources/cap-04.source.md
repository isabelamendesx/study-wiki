...
ware may invent important architectural characteristics based on unique factors.
...
with other products, systems, and components and/or perform its required func‐
...
These are not architecture characteristics but rather the motivational requirements to
build the software. This illustrates how thinking about the relationship between
architecture characteristics and the problem domain has evolved.
