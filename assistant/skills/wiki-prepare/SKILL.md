...
# /wiki-prepare — Preparar Fonte para Estudo

Extrai um capítulo de livro do EPUB (via pandoc), cria o `.source.md`, e preenche o template com TL;DR + Resumo.

## Entrada

O usuário informa o livro e o capítulo: `/wiki-prepare <livro> <capítulo>`

Ex: `/wiki-prepare fundamentos-eng-software cap-5`
...
7. **Dizer ao usuário**: "Pronto! Complete com seus insights e depois chame /wiki-ingest"
